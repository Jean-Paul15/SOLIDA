...
import { readSession, redirectIfAccessDenied, redirectIfUnauthenticated } from "@/lib/session";
      ...
      <div className="flex h-[88px] items-center justify-between rounded-lg border border-neutre-200 px-4">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2">
            <span className="text-base font-semibold text-neutre-950">{identite.nom_complet}</span>
