    ...
    <div className="flex flex-col gap-8">
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-5 flex flex-col gap-5">
          ...
          <Separator />
          <Rubrique
            titre="Mise à l'échelle du score"
            description="Formule probabilité → score (scorecard), indépendante du risque accepté."
          />
        ...
        <div className="col-span-7 flex flex-col gap-4 rounded-lg bg-solida-teal-50 p-4">
          ...
          <div className="flex flex-col gap-3 rounded-lg border border-neutre-200 bg-blanc p-4">
            <span className="text-xs font-medium text-neutre-500">
              Répartition sur l&rsquo;historique ({total} dossiers)
            </span>
            {(["accord", "accord_sous_condition", "comite_de_credit", "refus"] as const).map(
              (t) => (
                <div key={t} className="flex items-center gap-3">
                  ...
                  <span className="w-10 text-right font-mono text-sm text-neutre-950">
                    {compte(t)}
                  </span>
                </div>
              )
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-baseline justify-between">
          <Rubrique
            ...
            description="Indépendant des curseurs ci-dessus : plafond maximal appliqué quel que soit le score."
          />
