...
import { trajectoireEpargne } from "./trajectoire-epargne";
...
describe("trajectoireEpargne", () => {
  ...
  it("renvoie des mois vides sans mouvement", () => {
    const donnees = trajectoireEpargne(epargne([]), 3, maintenant);
