...
class Configuration(BaseSettings):
    ...
    modele_enrichi_path: str = "/app/modeles/bundle_enrichi"
    modele_enrichi_cache_path: str = "/var/cache/solida-modele-enrichi"
    mlflow_tracking_uri: str = ""
    mlflow_model_name: str = "solida-socle"
    mlflow_model_alias: str = "champion-demo"
    mlflow_model_name_enrichi: str = "solida-enrichi"
