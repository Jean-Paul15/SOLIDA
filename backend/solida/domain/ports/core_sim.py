...
class CoreSimReader(Protocol):
    ...
    def charger_societaire_par_numero_membre(self, numero_membre: str) -> Societaire | None:
        """Recherche anonyme (portail sociétaire, avant authentification) : par
        numéro de compte exact, jamais par nom — pas de fuite d'information avant
        que l'étape 2 (montant du dernier dépôt) ne confirme l'identité."""
        ...
