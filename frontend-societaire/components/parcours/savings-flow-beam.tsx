...
// Repris à l'identique de frontend/components/solida/SavingsFlowBeam.tsx (écran de
// connexion agent) pour que le panneau de marque desktop du portail sociétaire ait
// exactement le même design que la connexion agent.
const CHEMINS = [
...
export function SavingsFlowBeam() {
