...
ACCORD.}
\fichier{backend/\brk solida/\brk domain/\brk rules/\brk progressif.py::\brk{}lister\_conditions\_reexamen}
...
$\mathit{endettement\_seuil}$ & $50\,\%$ & Même origine. \\
\bottomrule
\end{tabular}
...
Constante & Valeur & Pourquoi cette valeur \\
\midrule
$\mathit{taille\_groupe\_minimale}$ & $3$ & Aucune source documentée au-delà de l'intuition
  qu'un groupe de 1 ou 2 membres ne peut pas produire une statistique de groupe fiable. \\
