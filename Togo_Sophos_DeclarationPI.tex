...
SOLIDA à la date de signature de la présente déclaration. Ce périmètre est figé par une étiquette
Git dédiée. \textit{[Étiquette et empreinte du commit à reporter ici avant signature.]} Les
développements réalisés pendant le hackathon n'en font pas partie (voir 1.4).
...
5 & TIGUE Essozolim Victoire & Produit et métier microfinance, UX/UI & \\
\bottomrule
\end{tabular}
\end{center}
